...
(function ($) {
  ...
  function jqCron (settings) {
    ...
    var _$cross = $('<span class="jqCron-cross">reset selection</span>')
    var _selectors = []
...
(function ($) {
  function jqCronSelector (_cron, _$block, _multiple, _type) {
    ...
    var _$selector = $('<span class="jqCron-selector"></span>') // TODO: here we need to change event
    var _values = {}
    var _value = []
    ...
    function array_unique (l) {
      var i = 0; var n = l.length; var k = {}; var a = []
      while (i < n) {
    ...
    this.getCronValue = function () {
      ...
      var cron = [_value[0]]; var i; var s = _value[0]; var c = _value[0]; var n = _value.length
      for (i = 1; i < n; i++) {
        if (_value[i] == c + 1) {
          c = _value[i]
    ...
    this.setValue = function (keys) {
      var i; var newKeys = []; var saved = _value.join(' ')
    ...
    this.getTitleText = function () {
      ...
      var cron = [getValueText(_value[0])]; var i; var s = _value[0]; var c = _value[0]; var n = _value.length
      for (i = 1; i < n; i++) {
        if (_value[i] == c + 1) {
          c = _value[i]
    ...
    _$selector
      ...
      .bind('selector:open', function () {
        if (_hasNumericTexts) {
          var nbcols = 1; var n = _$list.find('li').length
